...
export default function PricingPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0A0A0A', fontFamily: 'Inter, sans-serif' }}>
      ...
      {/* NAV */}
      <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: `16px ${px}`, borderBottom: '0.5px solid #1F1F1F' }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: isMobile ? '40px 16px' : '60px 24px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: isMobile ? '40px' : '56px' }}>
          ...
          <h1 style={{ fontSize: isMobile ? '26px' : '36px', fontWeight: '800', color: '#fff', margin: '0 0 12px', lineHeight: '1.2' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(2, 1fr)', gap: '20px', marginBottom: '40px' }}>
          ...
          {/* FREE */}
          <div style={{ background: '#111111', borderRadius: '16px', padding: isMobile ? '24px' : '32px', border: '0.5px solid #1F1F1F', display: 'flex', flexDirection: 'column' }}>
            <div style={{ marginBottom: '20px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '6px', margin: '10px 0 4px' }}>
                <span style={{ fontSize: isMobile ? '40px' : '48px', fontWeight: '800', color: '#fff', lineHeight: 1 }}>0</span>
            ...
            <div style={{ flex: 1, marginBottom: '24px' }}>
              {freeFeatures.map((feature, i) => (
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
                  ...
                  <span style={{ fontSize: isMobile ? '13px' : '14px', color: feature.included ? '#9CA3AF' : '#444' }}>
                    {feature.text}
                  </span>
                </div>
              ))}
          ...
          {/* PRO */}
          <div style={{ background: '#111111', borderRadius: '16px', padding: isMobile ? '24px' : '32px', border: '1.5px solid #10B981', position: 'relative', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '6px', margin: '10px 0 4px' }}>
                <span style={{ fontSize: isMobile ? '40px' : '48px', fontWeight: '800', color: '#fff', lineHeight: 1 }}>3 500</span>
                <span style={{ fontSize: '14px', color: '#6B7280' }}>FCFA/mois</span>
              </div>
            ...
            <div style={{ flex: 1, marginBottom: '24px' }}>
              {proFeatures.map((feature, i) => (
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
                  ...
                  <span style={{ fontSize: isMobile ? '13px' : '14px', color: '#9CA3AF' }}>{feature.text}</span>
                </div>
              ))}
            </div>
        ...
        {/* CALCULATEUR */}
        <div style={{ background: '#111111', borderRadius: '16px', padding: isMobile ? '20px' : '32px', border: '0.5px solid #1F1F1F', marginBottom: '24px' }}>
          <h2 style={{ fontSize: isMobile ? '16px' : '18px', fontWeight: '700', color: '#fff', margin: '0 0 8px' }}>Calculateur de commission</h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: isMobile ? '8px' : '16px' }}>
            {[
              ...
              <div key={i} style={{ background: item.bg, borderRadius: '10px', padding: isMobile ? '12px 8px' : '20px', textAlign: 'center', border: `0.5px solid ${item.color}30` }}>
                <p style={{ margin: '0 0 4px', fontSize: isMobile ? '10px' : '12px', color: '#6B7280', fontWeight: '600' }}>{item.label}</p>
                <p style={{ margin: '0 0 2px', fontSize: isMobile ? '16px' : '24px', fontWeight: '800', color: item.color }}>{item.value}</p>
        ...
        {/* GARANTIE */}
        <div style={{ textAlign: 'center', padding: isMobile ? '24px 16px' : '32px', background: '#10B98110', borderRadius: '16px', border: '0.5px solid #10B98130', marginBottom: '24px' }}>
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '8px', color: '#10B981' }}>
            <ShieldIcon />
          </div>
          <h3 style={{ fontSize: isMobile ? '14px' : '16px', fontWeight: '700', color: '#fff', margin: '0 0 8px' }}>Aucun engagement. Annule quand tu veux.</h3>
