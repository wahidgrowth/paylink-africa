  ...
  return (
    <div>
      ...
      <div style={{ background: '#111111', borderRadius: '12px', padding: '40px', border: '0.5px solid #1F1F1F', textAlign: 'center' }}>
        <h2 style={{ fontSize: '16px', fontWeight: '500', color: '#fff', margin: '0 0 8px' }}>Aucun produit cree</h2>
        <p style={{ fontSize: '14px', color: '#6B7280', margin: '0 0 20px' }}>Cree ton premier produit et commence a vendre.</p>
