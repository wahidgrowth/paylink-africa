    ...
    <div style={{ padding: '32px' }}>
      <style>{`
        @media (max-width: 767px) {
          .ac-wrap { padding: 16px !important; }
          .ac-inner { max-width: 100% !important; }
          .ac-profile-grid { grid-template-columns: 1fr !important; }
          .ac-plan-header { flex-direction: column !important; gap: 12px !important; align-items: flex-start !important; }
        }
      `}</style>

      <div className="ac-inner" style={{ maxWidth: '600px' }}>
        ...
        <div style={{ background: '#111111', borderRadius: '12px', padding: '24px', border: '0.5px solid #1F1F1F', marginBottom: '16px' }}>
          ...
          <div className="ac-profile-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '16px' }}>
            <div>
        ...
        <div style={{ background: '#111111', borderRadius: '12px', padding: '24px', border: '0.5px solid #1F1F1F', marginBottom: '16px' }}>
          ...
          <div className="ac-plan-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            <div>
